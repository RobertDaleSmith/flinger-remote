...
function connectionSuccess() {
    ...
    document.getElementById('invite_buttons_url').innerHTML  = '<a href="http://flinger.co/#' + BGP.docname + '" target="_blank">flinger.co/#' + BGP.docname + '</a>';
    document.getElementById('invite_buttons_url2').innerHTML = '<a href="http://remote.flinger.co/#' + BGP.docname + '" target="_blank">remote.flinger.co/#' + BGP.docname + '</a>';
